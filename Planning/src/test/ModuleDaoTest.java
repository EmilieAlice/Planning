...
public class ModuleDaoTest {
	...
	public void findModuleAvecHeures() {
		...
		Module moduleUn = new Module(1, "SI2", "Enseigner aux élèves les bases sur le fonctionnement du réseau internet", 
				"Des TP et des cours", 30, "Les prérequis sont le module SI1 et le binaire");
		Module moduleDeux = new Module(2, "Maths", "Enseigner aux élèves les notions de mathématiques nécessaires en informatique", 
				"Des cours théoriques et du python", 50, "Les prérequis sont le BAC");
