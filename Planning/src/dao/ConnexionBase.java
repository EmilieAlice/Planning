...
public class ConnexionBase {
	 ...
	 * Cela fournit une connexion à la base de données traducteur
	 */
	...
	static {
		try {
			...
			System.err.println("*** ERROR: Impossible to create an instance of " + DRIVER_NAME); System.err.println(e.getMessage());
		}
